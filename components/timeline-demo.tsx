...
export default function TimelineDemo() {
  ...
  const data = [
    {
      ...
      content: (
        <div className="mt-4 lg:mt-0">
          <p className="mb-6 text-xs sm:text-sm md:text-base lg:text-lg font-semibold text-white-100 dark:text-neutral-100">
            Company founded & first bid won
          </p>
          <div className="mb-8 space-y-3 space-y-3">
            <div className="flex items-center gap-2 text-xs sm:text-sm md:text-base lg:text-base text-white-700 dark:text-neutral-300">
  ...
  return (
   <div className="relative w-full overflow-clip -mt-12 lg:mt-0">
